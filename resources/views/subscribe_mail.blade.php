                      ...
                      <tr style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;">
                        <td style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;">
                          <div class="in-content" style="margin:0;padding:0;padding:30px;">
                            <h1 style="margin:0;font-family:Helvetica, Arial;line-height:1.4;color:#3f526d;font-weight:700;font-size:30px;margin:auto;padding:0;">Welcome From Blog Posts Application!</h1>
                            <h6 style="margin:0;font-family:Helvetica, Arial;line-height:1.4;color:#3f526d;font-weight:500;font-size:15px;margin:20px 0px 15px;padding:0;">Subject : Send Verification Code</h6><br>
                            <p style="margin:0;padding:0;font-family:Helvetica, Arial;margin-bottom:10px;font-weight:300;color:#96a6b0;font-size:50px;line-height:1.6;">
                              [{{$confirmation_code}}]
                            </p>
                            <p style="margin:0;padding:0;font-family:Helvetica, Arial;margin-bottom:10px;font-weight:300;color:#96a6b0;font-size:15px;line-height:1.6;">
                              Please Click Confirm to Subscribe.. 
                            </p>
                                        ...
                                        <tr style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;">
                                          <td style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;">
                                            <div style="margin:0;padding:0;text-align: center;width: 100%;">
                                              <a href="http://localhost:8000/confirmation" target="_blank" class="cta-button" style="margin:0;padding:0;display:inline-block;background:#8799f6;color:#fff;text-decoration:none;padding:15px 25px;border-radius:5px;font-size:14px;letter-spacing:1px;font-weight:100;margin:20px auto;">Confirm</a>                                              </div>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
  ...
  <tr>
    <td width="100%" valign="top" align="center" bgcolor="#eceeed">
      <table style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;width: 100%;max-width: 550px;margin: 0px auto;text-align: center;color: #ccc;font-size: 14px;" align="center">
        <tr style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;">
          <td style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;">&copy; 2020 ITVisonHub.co</td>
        </tr>
      </table>
    </td>
  </tr>
